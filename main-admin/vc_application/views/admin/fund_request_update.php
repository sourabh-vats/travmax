	<div class="page-heading"><a class="btn btn-primary flr" href="<?php echo base_url() . 'admin/fund_request_list'; ?>">Back</a>
	  <h2>Update Payment Proof Request</h2>
	</div>
  ...
  ?>
	<fieldset>
	  ...
	  <div class="form-group col-sm-6">
	    ...
	    <textarea class="form-control" name="description"><?php if ($this->input->post('description') != '') {
	  ...
	  <div class="form-group col-sm-6">
	    ...
	    <select name="status" class="form-control custom-select">
	      ...
	      <option <?php if ($prod['status'] == 'Rejected') {
                  echo 'selected="selected"';
                } ?> value="Rejected">Rejected</option>
	      <option <?php if ($prod['status'] == 'Completed') {
                  echo 'selected="selected"';
	  ...
	  <div class="form-group col-lg-6 col-mg-12 col-sm-6">
	    ...
	    <div class="form-group col-sm-2">
	      <?php if ($prod['image'] != '') {
          echo '<img src="' . base_url() . '../assets/images/' . $prod['image'] . '" width="50" height="50">';
        } ?>
