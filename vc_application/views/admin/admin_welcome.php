...
<div class="df">
	<span>My Installments <big> <?php //echo $credits;?></big> </span>
</div> 
</div> 
 </a> 
</div> 
...
<div class="imggg">
	...
	<div class="df adds_mny"><span> My Booking <big>  
 ...
 <div class="col-sm-4 bottm_bordr">
   ...
   <div class="col-sm-4 bottm_bordr1">
    ...
    <div class="col-sm-4 bottm_bordr">
        ...
        <big> <i class="fa fa-inr"></i> <?php $pending_money = $profile[0]['eligibility']-$approved_moneyback; if($pending_money >=0 ) { echo $pending_money; } else { echo 0; } ?></big>
...
<div class="co-middel">
   ...
   <div class="col-sm-4 bottm_bordr">
        ...
        <big> <?php if(array_key_exists(1, $team_consume)) { echo $team_consume[1]; } else { echo 0; } ?></big>
        <p class="mt-5 ammount-txt">These are my partners who have made purchases</p></div>
    </div>
    <div class="col-sm-4 bottm_bordr1">
        <div class="my-cashback-inner-first">
        <p class="p-inner">Inactive Partners</p>
        <big></i><?php if(array_key_exists(0, $team_consume)) { echo $team_consume[0]; } else { echo 0; } ?></big>
   ...
   <div class="row">
        ...
        <big>  <?php if(array_key_exists(33, $macro_partner)) { echo $macro_partner[33]; } else { echo 0; } ?></big>
