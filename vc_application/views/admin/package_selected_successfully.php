<div class="row d-flex justify-content-center flex-wrap">
    ...
    <h2 class="text-center">You have selected for Rs. and have taken the <?php echo $package_information[0]['payment_type']; ?> plan. Please make a payment of Rs. and share the proof with us</h2>
