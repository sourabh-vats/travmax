	 ...
	 label.checkbox{font-weight:normal;}
      ...
      if($this->session->flashdata('flash_message')){
        if($this->session->flashdata('flash_message') == 'activated')
        {
          echo '<div class="alert alert-success">';
            ...
            echo '<strong></strong> You Become Mega successfully.';
          echo '</div>';       
	  ...
	  //print_r($editor);
      if(empty($user)) {
      echo form_open('admin/become_mega', $attributes);
      ?>
        <fieldset>
      ...
      <?php echo form_close(); 
		  ...
		  echo form_open('admin/become_mega/'.$this->uri->segment(3), $attributes);
		  ?>
		 <fieldset>
		   <div class="form-group col-sm-4">
        ...
        <input type="hidden" name="product" value="25960" >
       <p><label>Activation Package: </label>&nbsp; 22000 + 3960 (18% GST) = INR 25960</p>		
       </div> 
