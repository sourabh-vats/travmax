...
<div class="smry smry4  text-center"><h2><b>Fund Request</b></h2>
</div>
      <div class="page-heading"><a class="btn btn-primary flr" href="<?php echo base_url().'admin'; ?>">Back</a>
        <!--<h2>Fund Request</h2>-->
      </div>
    ...
    <div class="form-group col-sm-12">
           <!-- <label> Name</label>
              <input type="text" class="form-control"  name="name" value="<?php if($this->input->post('name')!='') { echo $this->input->post('name'); }  ?>" >-->
          <label> Amount</label>
    ...
    <option value="Other">Other</option>
       ...
       <div class="form-group col-sm-12 utr">
        ...
        <div class="form-group col-sm-12 utr">
            <label class='two'>Image</label>
              <input type="file"   name="image" value="<?php if($this->input->post('file')!='') { echo $this->input->post('file'); }  ?>" >
          </div>
      ...
      <!--<div class="form-group col-lg-6 col-mg-6 col-sm-6">
            <label>Bank Name</label>
              <input type="file" class="form-control"  name="image" value="<?php if($this->input->post('image')!='') { echo $this->input->post('image'); }  ?>" >
          </div> -->
      
<div class="form-group col-sm-12">
            <label>Description</label>
              <textarea class="form-control" required="required" name="description" value="<?php if($this->input->post('description')!='') { echo $this->input->post('description'); } ?>" ></textarea>
          </div>
  ...
  <script>tinymce.init({ selector:'.textarea-editor',browser_spellcheck: true });
