				...
				<form method="post" action="">
					<div class="table-responsive">
						<table id="ContentPlaceHolder1_rb" class="ver12bldgray" style="width:100%;">
							<tbody>
								<tr>
									<td><span class="btn green" style="margin-bottom: 2px;"><label><input onclick="this.form.submit();" type="radio" name="level" value="1" <?php if ($this->input->post('level') == '' || $this->input->post('level') == '1') {
																																												echo 'checked="checked"';
																																											} ?>> Circle 1</label></span></td>

									<td><span class="btn green" style="margin-bottom: 2px;"><label><input type="radio" name="level" value="2" onclick="this.form.submit();" <?php if ($this->input->post('level') == '2') {
																																												echo 'checked="checked"';
																																											} ?>> Circle 2</label></span></td>

									<td><span class="btn green" style="margin-bottom: 2px;"><label><input <?php if ($this->input->post('level') == '3') {
																												echo 'checked="checked"';
																											} ?> type="radio" name="level" value="3" onclick="this.form.submit();"> Circle 3</label></span></td>

									<td><span class="btn green" style="margin-bottom: 2px;"><label><input <?php if ($this->input->post('level') == '4') {
																												echo 'checked="checked"';
