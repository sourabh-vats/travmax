...
<div class="col-sm-12 right-bar">
  ...
  <div class="form-group col-sm-6">
    ...
    <input type="text" class="form-control" required name="f_name" value="<?php if ($this->input->post('f_name') != '') {
                                                                            echo $this->input->post('f_name');
                                                                          } else {
                                                                            echo $user['f_name'];
                                                                          } ?>">
  </div>
  <div class="form-group col-sm-6">
    ...
    <input type="text" class="form-control" required name="l_name" value="<?php if ($this->input->post('l_name') != '') {
                                                                            echo $this->input->post('l_name');
                                                                          } else {
                                                                            echo $user['l_name'];
                                                                          } ?>">
  </div>
  ...
  <div class="form-group col-sm-6">
    ...
    <input type="text" class="form-control" placeholder="DD-MM-YYYY" name="dob" value="<?php if ($this->input->post('dob') != '') {
  ...
  <div class="form-group col-sm-6">
    <label>Phone</label>
    <input type="number" class="form-control" required name="phone" value="<?php if ($this->input->post('phone') != '') {
  ...
  <div class="form-group col-sm-6">
    <label>Address</label>
    <input type="text" class="form-control" required name="address" value="<?php if ($this->input->post('address') != '') {
  ...
  <div class="form-group col-sm-6 hide">
    <label>City</label>
    <input type="text" class="form-control" readonly="" required name="city" value="<?php if ($this->input->post('city') != '') {
  ...
  <div class="form-group col-sm-6 hide">
    <label>State</label>
    <input type="text" class="form-control" readonly="" required name="state" value="<?php if ($this->input->post('state') != '') {
  ...
  <div class="form-group col-sm-6">
    <label>Pincode</label>
    <input type="number" class="form-control" required name="pincode" value="<?php if ($this->input->post('pincode') != '') {
