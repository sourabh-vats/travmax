...
<div id="show" class="fileinput-preview thumbnail bult" style="">
	<img src="<?php echo base_url(); ?>images/userrrrr.png"> 
</div>


<div class="col-sm-12  protext text-center">
<h3><?php echo $this->session->userdata('full_name');?></h3>
<h3><?php if($user['macro'] > 0) { echo 'Macro Partner'; } else  { echo 'Micro Partner'; }   ?></h3>
</div>
...
<li <?php if($store=='') { echo 'class="home atv"'; }?>><a href="<?php echo base_url();?>admin"><i class="fa fa-user-circle-o" aria-hidden="true"></i>  My Account </a></li>
<li <?php if($store=='profile') { echo 'class="home atv"'; }?>><a href="<?php echo base_url();?>admin/profile"><i class="fa fa-file-o" aria-hidden="true"></i>  Personal Details</a></li>
<li <?php if($store=='kyc') { echo 'class="home atv"'; }?>><a href="<?php echo base_url();?>admin/kyc"><i class="fa fa-university" aria-hidden="true"></i> Payment Details</a></li>
...
<li <?php if($store=='upgrade_account') {echo 'class="home atv"'; }?>><a href="<?php echo base_url();?>admin/upgrade_user"><i class="fa fa-arrow-circle-up" aria-hidden="true"></i> Upgrade Account</a></li>
...
<li <?php if($store=='DistributorLevelInformation') {echo 'class="home atv"'; }?>><a href="<?php echo base_url();?>admin/DistributorLevelInformation"><i class="fa fa-safari" aria-hidden="true"></i> My Circle Information</a></li>
<li <?php if($store=='activity_log') {echo 'class="home atv"'; }?>><a href="<?php echo base_url();?>admin/activity_log"><i class="fa fa-address-card-o" aria-hidden="true"></i> Activity log</a></li>
<li <?php if($store=='wallet_history') {echo 'class="home atv"'; }?>><a href="<?php echo base_url();?>admin/wallet_history"><i class="fa fa-file" aria-hidden="true"></i> Wallet History</a></li>
