...
<meta property="og:site_name" content="Wishzon"/>
<meta property="og:url" content=""/>
<meta property="og:description" content=""/>

<meta name="google-site-verification" content="LyDawY5gRLZyMXlZ3HSS511JYudGnKlBS5hRmneWT8U" />

<meta name="verify-admitad" content="6fac1bf6a4" />
	...
	<li class="nav-item dropdown social-icons">
        ...
        <div class="dropdown-menu dropdown-menu1 " aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="<?php echo base_url();?>logout">Logout</a>
								...
								<?php } else { ?>
								<li class="drop-nav">
								    <a title="Login" href="javascript:;" data-toggle="modal" data-target="#registerLoginModal" ><i class="fa fa-sign-in"></i>  Login</a></li>
...
<script>$(document).ready(function(){$(".onlinemerchant").click(function(){$(".onlinemerchant").addClass("active");$(".inlinemerchant").removeClass("active")});$(".inlinemerchant").click(function(){$(".inlinemerchant").addClass("active");$(".onlinemerchant").removeClass("active")});$(".serch_icon").click(function(){$(".prdcity").toggle()})});</script>
