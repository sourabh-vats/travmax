        ...
        <div class="modal-body">
          ...
          <div class="col-sm-12 signup-sect sng-up" style="display:none">
            ...
            <form class="form" action="" method="post" id="popup-register-form">
              ...
              <p><label> Referral ID</label> <input type="text" id="bliss_code_input" name="bliss_code" class="form-control input-empty request-code-input" value="<?php echo $_GET['refer_id']; ?>"></p>
